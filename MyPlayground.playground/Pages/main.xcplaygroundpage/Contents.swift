...
func testingTesting123() {
    let country = "England"
    print("Can't wait to see what lies ahead for the future of \(country)")
}
...
func personsName(name:String)  {
    print("Salut \(name)! How are you")
}

personsName("beyonce")
personsName("jesse williams")
personsName("kendrick lamar")
/*: question4
...
func newFunction()  {
    var harryPottercharacter = "Hermione Granger"
    print("\(harryPottercharacter)")
    
    harryPottercharacter = "Ron Weasley"
    print(harryPottercharacter)
